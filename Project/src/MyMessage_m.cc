...
{
    this->HeaderSeqNum = 0;
    this->HeaderSendTime = 0;
    this->M_Type = 0;
    this->PiggybackingId = 0;
    this->PiggybackingAck = 0;
}
...
{
    this->HeaderSeqNum = other.HeaderSeqNum;
    this->HeaderSendTime = other.HeaderSendTime;
    this->M_Type = other.M_Type;
    this->M_Payload = other.M_Payload;
    this->Trailer = other.Trailer;
    this->PiggybackingId = other.PiggybackingId;
    this->PiggybackingAck = other.PiggybackingAck;
}

void MyMessage_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cPacket::parsimPack(b);
    doParsimPacking(b,this->HeaderSeqNum);
    doParsimPacking(b,this->HeaderSendTime);
    ...
    doParsimPacking(b,this->PiggybackingAck);
}

void MyMessage_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->HeaderSeqNum);
    doParsimUnpacking(b,this->HeaderSendTime);
    ...
    doParsimUnpacking(b,this->PiggybackingAck);
}

int MyMessage_Base::getHeaderSeqNum() const
{
    return this->HeaderSeqNum;
}

void MyMessage_Base::setHeaderSeqNum(int HeaderSeqNum)
{
    this->HeaderSeqNum = HeaderSeqNum;
}

double MyMessage_Base::getHeaderSendTime() const
{
    return this->HeaderSendTime;
}

void MyMessage_Base::setHeaderSendTime(double HeaderSendTime)
{
    this->HeaderSendTime = HeaderSendTime;
}
...
int MyMessage_Base::getPiggybackingAck() const
{
    return this->PiggybackingAck;
}

void MyMessage_Base::setPiggybackingAck(int PiggybackingAck)
{
    this->PiggybackingAck = PiggybackingAck;
}
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='H' && strcmp(fieldName, "HeaderSeqNum")==0) return base+0;
    if (fieldName[0]=='H' && strcmp(fieldName, "HeaderSendTime")==0) return base+1;
    ...
    if (fieldName[0]=='P' && strcmp(fieldName, "PiggybackingAck")==0) return base+6;
...
std::string MyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    MyMessage_Base *pp = (MyMessage_Base *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getHeaderSeqNum());
        case 1: return double2string(pp->getHeaderSendTime());
        ...
        case 6: return long2string(pp->getPiggybackingAck());
        default: return "";
    }
}
...
bool MyMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    MyMessage_Base *pp = (MyMessage_Base *)object; (void)pp;
    switch (field) {
        case 0: pp->setHeaderSeqNum(string2long(value)); return true;
        case 1: pp->setHeaderSendTime(string2double(value)); return true;
        ...
        case 6: pp->setPiggybackingAck(string2long(value)); return true;
